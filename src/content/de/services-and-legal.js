export const seoPages = [
  {
    ...
    process: [
      {
        title: 'Unterlagen klären',
        body: 'Wir besprechen, welche Belege, Konten und Zugänge für Ihre Situation relevant sind.',
      },
      {
        title: 'Abläufe strukturieren',
        body: 'Gemeinsam legen wir fest, wie Belege digital oder geordnet übergeben werden.',
      },
      {
        title: 'Laufend auswerten',
        body: 'Sie erhalten eine nachvollziehbare Buchhaltung und klare Hinweise zu offenen Punkten.',
      },
    ],
    faq: [
      {
        question: 'Welche Unterlagen brauche ich für die laufende Buchhaltung?',
        answer:
          'Typischerweise werden Ausgangsrechnungen, Eingangsrechnungen, Bankunterlagen, Kassa-Daten, Verträge und relevante Belege benötigt. Im Erstgespräch klären wir, welche Unterlagen für Ihr Unternehmen konkret notwendig sind.',
      },
      {
        question: 'Kann die Buchhaltung digital abgewickelt werden?',
        answer:
          'Ja. Eine digitale Abwicklung ist in vielen Fällen sinnvoll, weil Belege schneller verfügbar sind und Rückfragen besser nachvollzogen werden können. Die konkrete Umsetzung hängt von Ihren bestehenden Prozessen ab.',
      },
      {
  ...
  },
  {
    ...
    included: [
      'Besprechung laufender Steuerfragen und Fristen',
      'Vorbereitung und Begleitung von Steuererklärungen',
    ...
    process: [
      {
        ...
        body: 'Wir prüfen Geschäftsmodell, aktuelle Unterlagen und die dringendsten steuerlichen Fragen.',
      },
      {
        title: 'Optionen einordnen',
        body: 'Sie erhalten nachvollziehbare Empfehlungen mit Blick auf Fristen, Risiken und nächste Schritte.',
      },
      {
        title: 'Umsetzung begleiten',
        body: 'Wir unterstützen bei Erklärungen, Kommunikation und laufender steuerlicher Struktur.',
      },
    ],
    faq: [
      {
        question: 'Wann brauche ich einen Steuerberater in Wien?',
        answer:
          'Spätestens wenn laufende Steuerfragen, Umsatzsteuer, Gründung, Wachstum oder Finanzamt-Kommunikation Zeit kosten oder Unsicherheit erzeugen, ist steuerliche Beratung sinnvoll.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Wir unterstützen bei der Vorbereitung, Einordnung und Kommunikation rund um steuerliche Rückfragen. Welche Schritte sinnvoll sind, hängt vom konkreten Fall ab.',
      },
    ],
  ...
  },
  {
    ...
    included: [
      'Prüfung und Ordnung der relevanten Buchhaltungsunterlagen',
      'Abstimmung von offenen Posten, Konten und Belegen',
    ...
    process: [
      {
        ...
        body: 'Wir definieren, welche Belege, Saldenlisten, Verträge und Nachweise benötigt werden.',
      },
      {
        title: 'Abstimmungen durchführen',
        body: 'Offene Punkte werden strukturiert geprüft und nachvollziehbar dokumentiert.',
      },
      {
        title: 'Ergebnisse besprechen',
        body: 'Sie erhalten eine verständliche Einordnung der Zahlen und der nächsten Pflichten.',
      },
    ],
    faq: [
      {
        question: 'Welche Unterlagen werden für den Jahresabschluss benötigt?',
        answer:
          'Je nach Unternehmen können Buchhaltungsdaten, Bankunterlagen, offene Rechnungen, Anlagenverzeichnis, Verträge, Lohnunterlagen und weitere Nachweise relevant sein.',
      },
      {
        question: 'Wie läuft der Jahresabschluss ab?',
        answer:
          'Zuerst werden Unterlagen gesammelt und abgestimmt. Danach werden offene Punkte geklärt, Abschlussinformationen vorbereitet und die Ergebnisse besprochen.',
      },
      {
        question: 'Unterstützen Sie auch bei Rückfragen vom Finanzamt?',
        answer:
          'Ja. Wir helfen bei der Einordnung von Rückfragen und bei der strukturierten Vorbereitung der notwendigen Informationen.',
      },
      {
  ...
  },
  {
    ...
    included: [
      'Vorbereitung laufender Lohn- und Gehaltsabrechnungen',
      'An- und Abmeldungen sowie relevante monatliche Meldungen',
    ...
    process: [
      {
        title: 'Stammdaten aufnehmen',
        body: 'Wir klären Mitarbeiterdaten, Beschäftigungsform, Eintrittsdaten und vorhandene Unterlagen.',
      },
      {
        title: 'Monatliche Änderungen erfassen',
        body: 'Arbeitszeiten, Abwesenheiten und Änderungen werden rechtzeitig gesammelt.',
      },
      {
        title: 'Abrechnung abstimmen',
        body: 'Die laufenden Abrechnungen werden mit Buchhaltung und relevanten Fristen verbunden.',
      },
    ],
    faq: [
      {
        question: 'Welche Daten werden für die Lohnverrechnung benötigt?',
        answer:
          'Benötigt werden unter anderem Mitarbeiterstammdaten, Beschäftigungsbeginn, Arbeitszeit, Entgeltvereinbarung, Bankdaten und monatliche Änderungen wie Abwesenheiten.',
      },
      {
        question: 'Können Sie An- und Abmeldungen unterstützen?',
        answer:
          'Ja. Wir unterstützen bei der Vorbereitung der notwendigen Informationen und bei der geordneten Abwicklung relevanter Meldungen.',
      },
      {
  ...
  },
  {
    ...
    included: [
      'Einordnung von Rechtsform, Umsatzsteuer und ersten Fristen',
      'Setup von Buchhaltung, Belegablage und laufenden Abläufen',
    ...
    process: [
      {
        ...
        body: 'Wir besprechen Tätigkeit, erwartete Umsätze, Kostenstruktur und offene Fragen.',
      },
      {
        title: 'Pflichten einordnen',
        body: 'Sie erhalten einen Überblick über steuerliche und organisatorische Punkte, die jetzt wichtig sind.',
      },
      {
        title: 'Startstruktur festlegen',
        body: 'Wir definieren, wie Buchhaltung, Belege und Fristen nach der Gründung funktionieren sollen.',
      },
    ],
    faq: [
      {
        question: 'Welche Rechtsform passt zu meiner Gründung?',
        answer:
          'Das hängt von Tätigkeit, Risiko, erwarteten Umsätzen, Teamstruktur und langfristigen Plänen ab. Im Gespräch können die wichtigsten steuerlichen und organisatorischen Unterschiede eingeordnet werden.',
      },
      {
        question: 'Wann sollte ich vor der Gründung steuerliche Beratung einholen?',
        answer:
          'Am besten bevor Verträge, Rechnungslegung und laufende Prozesse fixiert werden. Frühe Beratung hilft, typische Umwege bei Buchhaltung, Umsatzsteuer und Fristen zu vermeiden.',
      },
      {
        question: 'Unterstützen Sie bei FinanzOnline und ersten steuerlichen Pflichten?',
        answer:
          'Ja. Wir helfen dabei, die ersten steuerlichen Pflichten zu verstehen und die notwendigen Abläufe für Erklärungen, Zahlungen und Unterlagen aufzusetzen.',
      },
      {
        question: 'Brauche ich schon vor dem ersten Umsatz eine Buchhaltung?',
        answer:
  ...
  },
  {
    ...
    included: [
      'Finanzielle Planung vor dem Start und nach den ersten Monaten',
      'Einordnung von Rechtsform, Buchhaltung und Steuerpflichten',
    ...
    process: [
      {
        ...
        body: 'Wir prüfen Idee, geplante Tätigkeit, Kosten, Umsatzannahmen und organisatorische Fragen.',
      },
      {
        title: 'Struktur festlegen',
        body: 'Rechtsform, Rechnungslegung, Buchhaltung und erste Pflichten werden nachvollziehbar eingeordnet.',
      },
      {
        title: 'Laufende Prozesse starten',
        body: 'Nach der Gründung werden Belegfluss, Fristen und Auswertungen so eingerichtet, dass sie tragfähig bleiben.',
      },
    ],
    faq: [
      {
        question: 'Welche steuerlichen Themen sind bei einer Unternehmensgründung in Wien wichtig?',
        answer:
          'Wichtig sind unter anderem Rechtsform, Umsatzsteuer, Einkommen- oder Körperschaftsteuer, Belegorganisation, Rechnungslegung und laufende Fristen.',
      },
      {
        question: 'Kann ich Buchhaltung und Gründungsberatung gemeinsam planen?',
        answer:
          'Ja. Das ist oft sinnvoll, weil die spätere Buchhaltung direkt davon profitiert, wenn Belege, Rechnungen und Fristen von Beginn an strukturiert sind.',
      },
      {
